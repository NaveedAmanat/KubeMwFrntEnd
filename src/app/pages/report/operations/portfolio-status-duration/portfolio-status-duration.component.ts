...
@Component({
  ...
  templateUrl: './portfolio-status-duration.component.html',
  styleUrls: ['./portfolio-status-duration.component.css'],
  providers: [
...
export class PortfolioStatusDurationComponent implements OnInit {
  ...
  portfolioStatusDurationReport() {
    ...
    this.operationsReportsService.printportfolioStatusDuration(toDt, frmDt, this.rpt_flg, areaSeq, regSeq, brnchSeq).subscribe((response) => {
      this.spinner.hide();
      var binaryData = [];
