...
@Component({
  ...
  templateUrl: './sales2-pending-report.component.html',
  styleUrls: ['./sales2-pending-report.component.css'],
  providers: [
...
export class Sales2PendingReportComponent implements OnInit {
  ...
  printSales2PendingReport() {
    ...
    let userId = this.auth.role;
    this.operationsReportsService.printSales2Pending(frmDt, toDt, branch).subscribe((response) => {
      this.spinner.hide();
      var binaryData = [];
