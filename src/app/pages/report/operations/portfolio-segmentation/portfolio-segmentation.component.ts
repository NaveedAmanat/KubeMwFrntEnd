...
@Component({
  ...
  templateUrl: './portfolio-segmentation.component.html',
  styleUrls: ['./portfolio-segmentation.component.css'],
  providers: [
    { provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE] },
    { provide: MAT_DATE_FORMATS, useValue: MY_FORMATS },
  ],
})
export class PortfolioSegmentationComponent implements OnInit {
  ...
  printReport() {
    ...
    this.operationsReportsService.printPortfolioSegmentation(toDt, role, regSeq, areaSeq, brnchSeq).subscribe((response) => {
      this.spinner.hide();
      var binaryData = [];
