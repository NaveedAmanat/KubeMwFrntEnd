...
@Component({
  ...
  templateUrl: './female-participation-ratio.component.html',
  styleUrls: ['./female-participation-ratio.component.css'],
  providers: [
...
export class FemaleParticipationRatioComponent implements OnInit {
  ...
  onSubmitFemaleParticipationRatio() {
    ...
    this.operationsReportsService.printFemaleParticipationRatio(new DatePipe('en-US').transform(dt, 'dd-MM-yyyy'), this.rpt_flg, areaSeq, regSeq, brnchSeq).subscribe((response) => {
      this.spinner.hide();
      var binaryData = [];
