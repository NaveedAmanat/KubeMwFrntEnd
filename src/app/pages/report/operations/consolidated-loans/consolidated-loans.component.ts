...
@Component({
  ...
  templateUrl: './consolidated-loans.component.html',
  styleUrls: ['./consolidated-loans.component.css'],
  providers: [
...
export class ConsolidatedLoansComponent implements OnInit {
...
rateOfRenewalReport() {
  ...
  this.operationsReportsService.printConsolidatedLoanReport(frmDt, toDt, this.rpt_flg, areaSeq, regSeq, brnchSeq).subscribe((response) => {
    this.spinner.hide();
    var binaryData = [];
