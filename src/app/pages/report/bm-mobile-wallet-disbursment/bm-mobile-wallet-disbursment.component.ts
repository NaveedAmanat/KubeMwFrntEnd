...
@Component({
  selector: 'app-bm-mobile-wallet-disbursment',
  templateUrl: './bm-mobile-wallet-disbursment.component.html',
  styleUrls: ['./bm-mobile-wallet-disbursment.component.css'],
  providers: [
...
export class BmMobileWalletDisbursmentComponent implements OnInit {
  ...
  printReport() {
    ...
    this.reportsService.printBmMobileWalletDisbursment(frmDt, toDt, this.ngForm.controls['branch'].value).subscribe((response) => {
      this.spinner.hide();
      var binaryData = [];
