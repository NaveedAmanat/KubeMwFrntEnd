...
@Component({
  selector: 'app-animal-missing-tag',
  templateUrl: './animal-missing-tag.component.html',
  styleUrls: ['./animal-missing-tag.component.css'],
  providers: [{ provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE] },
  { provide: MAT_DATE_FORMATS, useValue: MY_FORMATS }]
})

export class AnimalMissingTagComponent implements OnInit {
  ...
  portfolioStatusReport() {
    ...
    this.reportService.printAnimalMissingTag(toDt, brnchSeq).subscribe((response) => {
      this.spinner.hide();
      var binaryData = [];
