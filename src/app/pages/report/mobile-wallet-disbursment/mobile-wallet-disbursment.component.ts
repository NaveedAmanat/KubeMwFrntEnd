...
@Component({
  selector: 'app-mobile-wallet-disbursment',
  templateUrl: './mobile-wallet-disbursment.component.html',
  styleUrls: ['./mobile-wallet-disbursment.component.css'],
  providers: [
...
export class MobileWalletDisbursmentComponent implements OnInit {
  ...
  printReport() {
    ...
    this.reportsService.printMobileWalletDisbursment(frmDt, toDt, isXls).subscribe((response) => {
      this.spinner.hide();
      var binaryData = [];
