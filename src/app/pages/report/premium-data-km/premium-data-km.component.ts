...
@Component({
  selector: 'app-premium-data-km',
  templateUrl: './premium-data-km.component.html',
  styleUrls: ['./premium-data-km.component.css'],
  providers: [
...
export class PremiumDataKmComponent implements OnInit {
  ...
  premiumDataKM() {
    ...
    let fileName = 'premium_data_km_'+ new DatePipe('en-US').transform(this.date.value.endOf('month'), 'MMM-yyyy').toUpperCase();;
    this.reportsService.printAccountMonthlyReport(toDt, fileName,  2).subscribe((response) => {
      var binaryData = [];
