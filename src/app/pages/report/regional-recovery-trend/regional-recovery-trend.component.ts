...
@Component({
  selector: 'app-regional-recovery-trend',
  templateUrl: './regional-recovery-trend.component.html',
  styleUrls: ['./regional-recovery-trend.component.css']
})
export class RegionalRecoveryTrendComponent implements OnInit {
  ...
  printReport() {
    ...
    this.reportsService.printRegionalRecoveryTrend(frmDt, toDt, this.ngForm.get("regSeq").value, this.ngForm.get("areaSeq").value).subscribe((response) => {
      this.spinner.hide();
      var binaryData = [];
