...
@Component({
  selector: 'app-clients-loan-maturity',
  templateUrl: './clients-loan-maturity.component.html',
  styleUrls: ['./clients-loan-maturity.component.css'],
  providers: [
...
export class ClientsLoanMaturityComponent implements OnInit {
  ...
  printReport() {
    ...
    this.reportsService.printClientLoanMaturity(toDt, isXls).subscribe((response) => {
      this.spinner.hide();
      var binaryData = [];
