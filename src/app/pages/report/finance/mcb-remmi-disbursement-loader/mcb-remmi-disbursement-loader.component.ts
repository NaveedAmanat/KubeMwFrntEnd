...
@Component({
  selector: 'app-mcb-remmi-disbursement-loader',
  templateUrl: './mcb-remmi-disbursement-loader.component.html',
  styleUrls: ['./mcb-remmi-disbursement-loader.component.css'],
  providers: [
    { provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE] },
    { provide: MAT_DATE_FORMATS, useValue: MY_FORMATS },
  ],
})
export class McbRemmiDisbursementLoaderComponent implements OnInit {
  ngForm: FormGroup;
  frmDt: string;
  toDt: string;
  maxDate: Date;
  ...
  mcbRemitanceDisb() {
    ...
    console.log(isXls);
    this.financeService.printMcbRemitDisbLoader(frmDt, toDt, isXls).subscribe((response) => {
      this.spinner.hide();
      var binaryData = [];
