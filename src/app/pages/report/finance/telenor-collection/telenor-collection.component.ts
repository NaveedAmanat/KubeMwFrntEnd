...
@Component({
  selector: 'app-telenor-collection',
  templateUrl: './telenor-collection.component.html',
  styleUrls: ['./telenor-collection.component.css'],
  providers: [
  ...
  */
export class TelenorCollectionComponent implements OnInit {
  ...
  printReport() {
    ...
    this.financeService.printTelenorReport(frmDt, toDt, brnchSeq, channelSeq, isXls).subscribe((response) => {
      this.spinner.hide();
      var binaryData = [];
