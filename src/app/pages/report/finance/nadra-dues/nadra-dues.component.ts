...
@Component({
  selector: 'app-nadra-dues',
  templateUrl: './nadra-dues.component.html',
  styleUrls: ['./nadra-dues.component.css']
})
export class NadraDuesComponent implements OnInit {
  ...
  nadraDues() {
    ...
    console.log(isXls);
    this.financeService.printNadraDues(true).subscribe((response) => {
      this.spinner.hide();
      var binaryData = [];
