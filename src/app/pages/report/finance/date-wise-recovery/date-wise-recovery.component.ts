...
@Component({
  selector: 'app-date-wise-recovery',
  templateUrl: './date-wise-recovery.component.html',
  styleUrls: ['./date-wise-recovery.component.css'],
  providers: [
    { provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE] },
    { provide: MAT_DATE_FORMATS, useValue: MY_FORMATS },
  ],
  })
export class DateWiseRecoveryComponent implements OnInit {
  ...
  dateWiseRecovery() {
    ...
    this.financeService.printDateWiseRecovery(frmDt, toDt, isXls).subscribe((response) => {
      this.spinner.hide();
      var binaryData = [];
