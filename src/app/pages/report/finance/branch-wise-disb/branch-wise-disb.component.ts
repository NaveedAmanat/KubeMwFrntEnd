...
@Component({
  selector: 'app-branch-wise-disb',
  templateUrl: './branch-wise-disb.component.html',
  styleUrls: ['./branch-wise-disb.component.css'],
  providers: [
    { provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE] },
    { provide: MAT_DATE_FORMATS, useValue: MY_FORMATS },
  ],
})
export class BranchWiseDisbComponent implements OnInit {
  ngForm: FormGroup;
  frmDt: string;
  toDt: string;
  maxDate: Date;
  ...
  branchWiseDisb() {
    ...
    this.financeService.printBranchWiseDisb(frmDt, toDt, isXls).subscribe((response) => {
      this.spinner.hide();
      var binaryData = [];
