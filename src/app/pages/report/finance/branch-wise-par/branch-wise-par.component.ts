...
@Component({
  selector: 'app-branch-wise-par',
  templateUrl: './branch-wise-par.component.html',
  styleUrls: ['./branch-wise-par.component.css'],
  providers: [
    { provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE] },
    { provide: MAT_DATE_FORMATS, useValue: MY_FORMATS },
  ],
})
export class BranchWiseParComponent implements OnInit {
  ...
  printReport() {
    ...
    this.financeService.printBranchWisePar(toDt).subscribe((response) => {
      this.spinner.hide();
      var binaryData = [];
