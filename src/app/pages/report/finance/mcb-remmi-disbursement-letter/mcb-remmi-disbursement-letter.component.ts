...
@Component({
  selector: 'app-mcb-remmi-disbursement-letter',
  templateUrl: './mcb-remmi-disbursement-letter.component.html',
  styleUrls: ['./mcb-remmi-disbursement-letter.component.css'],
  providers: [
    { provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE] },
    { provide: MAT_DATE_FORMATS, useValue: MY_FORMATS },
  ],
  })
export class McbRemmiDisbursementLetterComponent implements OnInit {
  ...
  mcbRemitanceDisb() {
    ...
    this.financeService.printMcbRemitDisbLetter(frmDt, toDt, isXls).subscribe((response) => {
      this.spinner.hide();
      var binaryData = [];
