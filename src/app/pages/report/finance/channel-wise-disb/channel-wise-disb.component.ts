...
@Component({
  selector: 'app-channel-wise-disb',
  templateUrl: './channel-wise-disb.component.html',
  styleUrls: ['./channel-wise-disb.component.css'],
  providers: [
    { provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE] },
    { provide: MAT_DATE_FORMATS, useValue: MY_FORMATS },
  ],
})
export class ChannelWiseDisbComponent implements OnInit {
  ...
  channelWiseDisb() {
    ...
    this.financeService.printChannelWiseDisb(frmDt, toDt, isXls).subscribe((response) => {
      this.spinner.hide();
      var binaryData = [];
