...
@Component({
  selector: 'app-abl-loan-recovery-dues',
  templateUrl: './abl-loan-recovery-dues.component.html',
  styleUrls: ['./abl-loan-recovery-dues.component.css']
})
export class AblLoanRecoveryDuesComponent implements OnInit {
  ...
  ablLoanDues() {
    ...
    console.log(isXls);
    this.financeService.printAblLoanRecoveryDues(true).subscribe((response) => {
      this.spinner.hide();
      var binaryData = [];
