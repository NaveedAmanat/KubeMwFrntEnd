...
@Component({
  selector: 'app-product-wise-portfolio',
  templateUrl: './product-wise-portfolio.component.html',
  styleUrls: ['./product-wise-portfolio.component.css'],
  providers: [
    { provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE] },
    { provide: MAT_DATE_FORMATS, useValue: MY_FORMATS },
  ],
})
export class ProductWisePortfolioComponent implements OnInit {
  ...
  printReport() {
    ...
    this.financeService.printProductWisePortfolio(toDt).subscribe((response) => {
      this.spinner.hide();
      var binaryData = [];
