...
@Component({
  selector: 'app-mcb-remi-maped-brnch-list',
  templateUrl: './mcb-remi-maped-brnch-list.component.html',
  styleUrls: ['./mcb-remi-maped-brnch-list.component.css']
})
export class McbRemiMapedBrnchListComponent implements OnInit {
  ...
  print() {
    ...
    this.financeService.printMcbRemiMapped(isXls).subscribe((response) => {
      this.spinner.hide();
      var binaryData = [];
