...
@Component({
  selector: 'app-product-wise-disb',
  templateUrl: './product-wise-disb.component.html',
  styleUrls: ['./product-wise-disb.component.css'],
  providers: [
    { provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE] },
    { provide: MAT_DATE_FORMATS, useValue: MY_FORMATS },
  ],
  })
export class ProductWiseDisbComponent implements OnInit {
  ngForm: FormGroup;
  frmDt: string;
  toDt: string;
  maxDate: Date;
  ...
  productWiseDisb() {
    ...
    this.financeService.printProductWiseDisb(frmDt, toDt, isXls).subscribe((response) => {
      this.spinner.hide();
      var binaryData = [];
