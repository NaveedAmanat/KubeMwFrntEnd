...
@Component({
  selector: 'app-clnt-upload-jazz-dues',
  templateUrl: './clnt-upload-jazz-dues.component.html',
  styleUrls: ['./clnt-upload-jazz-dues.component.css']
})
export class ClntUploadJazzDuesComponent implements OnInit {
  ...
  clntInfoJazz() {
    ...
    console.log(isXls);
    this.financeService.printClntUploadJazzDues(true).subscribe((response) => {
      this.spinner.hide();
      var binaryData = [];
