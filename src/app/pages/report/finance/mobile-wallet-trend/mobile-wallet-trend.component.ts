...
@Component({
  selector: 'app-mobile-wallet-trend',
  templateUrl: './mobile-wallet-trend.component.html',
  styleUrls: ['./mobile-wallet-trend.component.css'],
  providers: [
    { provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE] },
    { provide: MAT_DATE_FORMATS, useValue: MY_FORMATS },
  ],
  })
export class MobileWalletTrendComponent implements OnInit {
  ngForm: FormGroup;
  frmDt: string;
  toDt: string;
  maxDate: Date;
