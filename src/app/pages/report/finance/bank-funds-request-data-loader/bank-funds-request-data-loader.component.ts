...
@Component({
  selector: 'app-bank-funds-request-data-loader',
  templateUrl: './bank-funds-request-data-loader.component.html',
  styleUrls: ['./bank-funds-request-data-loader.component.css'],
  providers: [
    { provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE] },
    { provide: MAT_DATE_FORMATS, useValue: MY_FORMATS },
  ],
})
export class BankFundsRequestDataLoaderComponent implements OnInit {
  ngForm: FormGroup;
  frmDt: string;
  toDt: string;
  maxDate: Date;
  ...
  ptintReport(){
    ...
    this.financeService.printBankFundsRequestDataLoader(frmDt, toDt,  isXls).subscribe((response) => {
      var binaryData = [];
      this.spinner.hide();
