...
@Component({
  selector: 'app-province-wise-ost-portfolio',
  templateUrl: './province-wise-ost-portfolio.component.html',
  styleUrls: ['./province-wise-ost-portfolio.component.css'],
  providers: [
    { provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE] },
    { provide: MAT_DATE_FORMATS, useValue: MY_FORMATS },
  ],
})
export class ProvinceWiseOstPortfolioComponent implements OnInit {
  ngForm: FormGroup;
  maxDate: Date;
  branchs: Branch[];
  ...
  printReport() {
    ...
    this.financeService.printProvinceWiseOutstandingPortfolio(toDt).subscribe((response) => {
      this.spinner.hide();
      var binaryData = [];
