...
@Component({
  selector: 'app-branch-wise-recovery',
  templateUrl: './branch-wise-recovery.component.html',
  styleUrls: ['./branch-wise-recovery.component.css'],
  providers: [
    { provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE] },
    { provide: MAT_DATE_FORMATS, useValue: MY_FORMATS },
  ],
})
export class BranchWiseRecoveryComponent implements OnInit {
  ...
  brachWiseRecovery() {
    ...
    this.financeService.printBranchWiseRecovery(frmDt, toDt, isXls).subscribe((response) => {
      this.spinner.hide();
      var binaryData = [];
