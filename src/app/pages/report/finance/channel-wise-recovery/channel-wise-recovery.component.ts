...
@Component({
  selector: 'app-channel-wise-recovery',
  templateUrl: './channel-wise-recovery.component.html',
  styleUrls: ['./channel-wise-recovery.component.css'],
  providers: [
    { provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE] },
    { provide: MAT_DATE_FORMATS, useValue: MY_FORMATS },
  ],
  })
export class ChannelWiseRecoveryComponent implements OnInit {
  ...
  channelWiseRecovery() {
    ...
    this.financeService.printChannelWiseRecovery(frmDt, toDt, isXls).subscribe((response) => {
      this.spinner.hide();
      var binaryData = [];
