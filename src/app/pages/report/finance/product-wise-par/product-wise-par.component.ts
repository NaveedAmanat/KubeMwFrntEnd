...
@Component({
  selector: 'app-product-wise-par',
  templateUrl: './product-wise-par.component.html',
  styleUrls: ['./product-wise-par.component.css'],
  providers: [
    { provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE] },
    { provide: MAT_DATE_FORMATS, useValue: MY_FORMATS },
  ],
})
export class ProductWiseParComponent implements OnInit {
  ...
  printReport() {
    ...
    this.financeService.printProductWisePar(toDt).subscribe((response) => {
      this.spinner.hide();
      var binaryData = [];
