...
@Component({
  selector: 'app-easy-paisa-loader',
  templateUrl: './easy-paisa-loader.component.html',
  styleUrls: ['./easy-paisa-loader.component.css'],
  providers: [
    { provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE] },
    { provide: MAT_DATE_FORMATS, useValue: MY_FORMATS },
  ],
})
export class EasyPaisaLoaderComponent implements OnInit {
  ngForm: FormGroup;
  frmDt: string;
  toDt: string;
  maxDate: Date;
  ...
  getReport(paymentMode){
    ...
    this.financeService.printMobileWalletLoader(frmDt, toDt, paymentMode,  isXls).subscribe((response) => {
      var binaryData = [];
      this.spinner.hide();
