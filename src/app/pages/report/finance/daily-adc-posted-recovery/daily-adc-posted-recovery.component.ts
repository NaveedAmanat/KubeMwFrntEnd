...
@Component({
  selector: 'app-daily-adc-posted-recovery',
  templateUrl: './daily-adc-posted-recovery.component.html',
  styleUrls: ['./daily-adc-posted-recovery.component.css'],
  providers: [
    { provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE] },
    { provide: MAT_DATE_FORMATS, useValue: MY_FORMATS },
  ],
  })
export class DailyAdcPostedRecoveryComponent implements OnInit {
  ...
  dailyADCsRecovery() {
    ...
    this.financeService.printADCsPostedRecovery(frmDt, toDt, isXls).subscribe((response) => {
      this.spinner.hide();
      var binaryData = [];
