...
@Component({
  selector: 'app-loan-cycle-wise-portfolio',
  templateUrl: './loan-cycle-wise-portfolio.component.html',
  styleUrls: ['./loan-cycle-wise-portfolio.component.css'],
  providers: [
    { provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE] },
    { provide: MAT_DATE_FORMATS, useValue: MY_FORMATS },
  ],
})
export class LoanCycleWisePortfolioComponent implements OnInit {
  ngForm: FormGroup;
  maxDate: Date;
  branchs: Branch[];  
  ...
  printReport() {
    ...
    this.financeService.printLoanCycleWisePortfolio(toDt).subscribe((response) => {
      this.spinner.hide();
      var binaryData = [];
