...
@Component({
  selector: 'app-sector-wise-portfolio',
  templateUrl: './sector-wise-portfolio.component.html',
  styleUrls: ['./sector-wise-portfolio.component.css'],
  providers: [
    { provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE] },
    { provide: MAT_DATE_FORMATS, useValue: MY_FORMATS },
  ],
})
export class SectorWisePortfolioComponent implements OnInit {
  ngForm: FormGroup;
  maxDate: Date;
  branchs: Branch[];
  ...
  printReport() {
    ...
    this.financeService.printSectorWisePortfolio(toDt).subscribe((response) => {
      this.spinner.hide();
      var binaryData = [];
