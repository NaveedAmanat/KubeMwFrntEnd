...
@Component({
  selector: 'app-clnt-info-jazz-dues',
  templateUrl: './clnt-info-jazz-dues.component.html',
  styleUrls: ['./clnt-info-jazz-dues.component.css']
})
export class ClntInfoJazzDuesComponent implements OnInit {
  ...
  clntInfoJazz() {
    ...
    console.log(isXls);
    this.financeService.printClntInfoJazzDues(true).subscribe((response) => {
      this.spinner.hide();
      var binaryData = [];
