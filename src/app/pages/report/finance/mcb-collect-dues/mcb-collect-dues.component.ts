...
@Component({
  selector: 'app-mcb-collect-dues',
  templateUrl: './mcb-collect-dues.component.html',
  styleUrls: ['./mcb-collect-dues.component.css']
})
export class McbCollectDuesComponent implements OnInit {
  ...
  mcbCollectDues() {
    ...
    console.log(isXls);
    this.financeService.printMcbCollect(true).subscribe((response) => {
      this.spinner.hide();
      var binaryData = [];
