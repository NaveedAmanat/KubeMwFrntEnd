...
@Component({
  selector: 'app-branch-wise-disb-and-reversal',
  templateUrl: './branch-wise-disb-and-reversal.component.html',
  styleUrls: ['./branch-wise-disb-and-reversal.component.css'],
  providers: [
    { provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE] },
    { provide: MAT_DATE_FORMATS, useValue: MY_FORMATS },
  ],
  })
export class BranchWiseDisbAndReversalComponent implements OnInit {
  ...
  brnchWiseDisbAndRevesal() {
    ...
    this.financeService.printBranchWiseReversal(frmDt, toDt, isXls).subscribe((response) => {
      this.spinner.hide();
      var binaryData = [];
