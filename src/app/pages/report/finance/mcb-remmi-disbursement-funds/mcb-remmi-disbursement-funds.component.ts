...
@Component({
  selector: 'app-mcb-remmi-disbursement-funds',
  templateUrl: './mcb-remmi-disbursement-funds.component.html',
  styleUrls: ['./mcb-remmi-disbursement-funds.component.css'],
  providers: [
    { provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE] },
    { provide: MAT_DATE_FORMATS, useValue: MY_FORMATS },
  ],
})
export class McbRemmiDisbursementFundsComponent implements OnInit {
  ngForm: FormGroup;
  frmDt: string;
  toDt: string;
  maxDate: Date;
  ...
  mcbRemitanceDisb() {
    ...
    console.log(isXls);
    this.financeService.printMcbRemitDisbFunds(frmDt, toDt, isXls).subscribe((response) => {
      this.spinner.hide();
      var binaryData = [];
