...
@Component({
  selector: 'app-top-sheet-transfer-clients',
  templateUrl: './top-sheet-transfer-clients.component.html',
  styleUrls: ['./top-sheet-transfer-clients.component.css'],
  providers: [
    { provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE] },
    { provide: MAT_DATE_FORMATS, useValue: MY_FORMATS },
  ],
  })
export class TopSheetTransferClientsComponent implements OnInit {
  ...
  topSheetTransferClients() {
    ...
    this.reportsService.printTopSheetTransferClients(frmDt, toDt, this.ngForm.controls['branch'].value, isXls).subscribe((response) => {
      this.spinner.hide();
      var binaryData = [];
