...
@Component({
  selector: 'app-regional-risk-flagging-report',
  templateUrl: './regional-risk-flagging-report.component.html',
  styleUrls: ['./regional-risk-flagging-report.component.css']
})
export class RegionalRiskFlaggingReportComponent implements OnInit {
  ...
  printReport() {
    ...
    this.reportsService.printRegionalRiskFlgging(frmDt, toDt, this.ngForm.get("regSeq").value, this.ngForm.get("areaSeq").value).subscribe((response) => {
      this.spinner.hide();
      var binaryData = [];
