...
@Component({
  ...
  templateUrl: './area-disbursment-report.component.html',
  styleUrls: ['./area-disbursment-report.component.css'],
  providers: [
...
export class AreaDisbursmentReportComponent implements OnInit {
  ...
  submitAreaDisbursement() {
    ...
    this.operationService.printAreaDisbursementReport(toDt, this.rpt_flg, areaSeq, regSeq, brnchSeq).subscribe((response) => {
      this.spinner.hide();
      var binaryData = [];
