...
@Component({
  ...
  templateUrl: './advance-client-report.component.html',
  styleUrls: ['./advance-client-report.component.css'],
  providers: [
...
export class AdvanceClientReportComponent implements OnInit {
  ...
  submitAdvanceClient() {
    ...
    this.operationService.printAdvanceClientReport(toDt, frmDt, this.rpt_flg, areaSeq, regSeq, brnchSeq).subscribe((response) => {
      this.spinner.hide();
      var binaryData = [];
