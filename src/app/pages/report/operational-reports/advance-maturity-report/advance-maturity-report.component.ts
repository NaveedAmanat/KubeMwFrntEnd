...
@Component({
  ...
  templateUrl: './advance-maturity-report.component.html',
  styleUrls: ['./advance-maturity-report.component.css'],
  providers: [
...
export class AdvanceMaturityReportComponent implements OnInit {
  ...
  submitAdvanceMaturity() {
    ...
    this.operationService.printAdvanceMaturityReport(toDt, this.rpt_flg, areaSeq, regSeq, brnchSeq).subscribe((response) => {
      this.spinner.hide();
      var binaryData = [];
