...
@Component({
  ...
  templateUrl: './late-closing-report.component.html',
  styleUrls: ['./late-closing-report.component.css'],
  providers: [
...
export class LateClosingReportComponent implements OnInit {
  ...
  printLateClosingReport() {
    ...
    this.operationService.printLateClosingReportForAllArea(toDt, frmDt, this.rpt_flg, areaSeq, regSeq, brnchSeq).subscribe((response) => {
      this.spinner.hide();
      var binaryData = [];
