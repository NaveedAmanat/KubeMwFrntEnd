...
@Component({
  ...
  templateUrl: './advance-recovery-report-overall.component.html',
  styleUrls: ['./advance-recovery-report-overall.component.css'],
  providers: [
...
export class AdvanceRecoveryReportOverallComponent implements OnInit {
  ...
  submitAdvanceRecovery() {
    ...
    this.operationService.printAdvanceRecoveryOverallReport(toDt, frmDt, this.rpt_flg, areaSeq, regSeq, brnchSeq).subscribe((response) => {
      this.spinner.hide();
      var binaryData = [];
