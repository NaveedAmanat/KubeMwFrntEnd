...
export class ClientDataComponent implements OnInit {
  ...
  ClientData() {
    ...
    let fileName = 'client_data_' + new DatePipe('en-US').transform(this.date.value.endOf('month'), 'MMM-yyyy').toUpperCase();
    this.reportsService.printAccountMonthlyReport(toDt, fileName , 1).subscribe((response) => {
      var binaryData = [];
